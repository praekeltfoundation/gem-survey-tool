...
STATIC_ROOT = os.path.join(PATH, 'gems/core/static')
...
SECRET_KEY = 's)5r8ul0!ck_tyg)2w-h2#s^v(lzesw^x=3ctpt4sqmhz34=!h'
...
TEMPLATE_DIRS = (
    ...
    # Don't forget to use absolute paths, not relative paths.
    'templates',
    join(BASE_DIR, 'gems', 'core', 'templates'),
)
