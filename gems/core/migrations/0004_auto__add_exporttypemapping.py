...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExportTypeMapping'
        db.create_table(u'core_exporttypemapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cast', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'core', ['ExportTypeMapping'])


    def backwards(self, orm):
        # Deleting model 'ExportTypeMapping'
        db.delete_table(u'core_exporttypemapping')
