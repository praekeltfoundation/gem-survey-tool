...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_tasklogger', (
            ...
            ('task_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'core.tasklogger': {
            ...
            'task_name': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        }
    }
