...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncomingSurvey.timestamp'
        db.alter_column(u'core_incomingsurvey', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'IncomingSurvey.timestamp'
        db.alter_column(u'core_incomingsurvey', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
