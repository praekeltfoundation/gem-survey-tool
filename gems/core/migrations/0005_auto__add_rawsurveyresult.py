...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RawSurveyResult'
        db.create_table(u'core_rawsurveyresult', (
        ...
        db.send_create_signal(u'core', ['RawSurveyResult'])


    def backwards(self, orm):
        # Deleting model 'RawSurveyResult'
        db.delete_table(u'core_rawsurveyresult')
