...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
       db.execute('create schema gems_reporting') 

    def backwards(self, orm):
       db.execute('drop schema gems_reporting')
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
