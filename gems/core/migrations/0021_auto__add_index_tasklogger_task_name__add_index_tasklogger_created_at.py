...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TaskLogger', fields ['task_name']
        db.create_index(u'core_tasklogger', ['task_name'])

        # Adding index on 'TaskLogger', fields ['created_at']
        db.create_index(u'core_tasklogger', ['created_at'])


    def backwards(self, orm):
        # Removing index on 'TaskLogger', fields ['created_at']
        db.delete_index(u'core_tasklogger', ['created_at'])

        # Removing index on 'TaskLogger', fields ['task_name']
        db.delete_index(u'core_tasklogger', ['task_name'])
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 6, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
