...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContactGroup.group_id'
        db.delete_column(u'core_contactgroup', 'group_id')


    def backwards(self, orm):
        # Adding field 'ContactGroup.group_id'
        db.add_column(u'core_contactgroup', 'group_id',
                      self.gf('django.db.models.fields.CharField')(default=123, max_length=5),
                      keep_default=False)
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 4, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
