...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactGroupMember.synced'
        db.add_column(u'core_contactgroupmember', 'synced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactGroupMember.synced'
        db.delete_column(u'core_contactgroupmember', 'synced')
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
