...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_contact', 'created_on',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 9, 2, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.created_on'
        db.delete_column(u'core_contact', 'created_on')
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
