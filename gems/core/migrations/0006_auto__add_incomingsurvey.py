...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IncomingSurvey'
        db.create_table(u'core_incomingsurvey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('raw_message', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'core', ['IncomingSurvey'])


    def backwards(self, orm):
        # Deleting model 'IncomingSurvey'
        db.delete_table(u'core_incomingsurvey')
