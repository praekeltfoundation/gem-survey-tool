...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SentMessage.created_at'
        db.alter_column(u'core_sentmessage', 'created_at', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'SentMessage.created_at'
        db.alter_column(u'core_sentmessage', 'created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'core.contact': {
            ...
            'created_on': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 3, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
